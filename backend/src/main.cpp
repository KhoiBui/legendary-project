...
int main() {
    ...
    CROW_ROUTE(app, "/applications")
        .methods(crow::HTTPMethod::Post)(
            [](const crow::request &request) { return postApps(request); });

    CROW_ROUTE(app, "/applications").methods(crow::HTTPMethod::Get)([](const crow::request &req) {
    ...
    CROW_ROUTE(app, "/donations").methods(crow::HTTPMethod::Get)([](const crow::request &req) {
        auto query = req.url_params;
    ...
    CROW_ROUTE(app, "/applications").methods(crow::HTTPMethod::Put)([](const crow::request &req) {
        std::ifstream file("applications.json");
